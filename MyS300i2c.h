...
This library was forked from the following source code:
https://github.com/mhorimoto/ELT_S300_HOLLY

2026/3/10 H.kurosaki
*/


#ifndef MY_ELT_S300_I2C
#define MY_ELT_S300_I2C
...
class S300I2C {
 public:
  ...
  void tgtPPMCalibration(uint16_t tgt);  // Target PPM Calibration
